...
const Experience = () => {
  ...
  return (
    <section className="section-padding relative" id="experience">
      ...
      <div
        ref={trackRef}
        className="flex gap-5 overflow-x-auto snap-x snap-mandatory cursor-grab active:cursor-grabbing px-6 md:px-12 lg:px-20 pb-6 scroll-smooth no-scrollbar"
        style={{ scrollbarWidth: "none" }}
      >
        {experiences.map((exp) => (
          <article
            key={exp.company}
            className="snap-start shrink-0 w-[88vw] md:w-[480px] card-dark p-7 transition-transform duration-300 hover:-translate-y-1"
          >
